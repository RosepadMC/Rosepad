...
public class GuiAddServer extends GuiScreen {
    ...
    public GuiAddServer(final GuiMultiplayerList screen) {
    ...
    public void actionPerformed() {
        ...
        this.controlList.add(new GuiSmallButton(0,
                this.width / 3 - 75, this.height / 4 * 3 + 20, "Add"));
    ...
    protected void actionPerformed(final GuiButton button) {
        ...
        if (button.id == 0) {
            parentScreen.addToList(this.ipText);
            parentScreen.actionPerformed();
        }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float renderPartialTick) {
        ...
        this.drawCenteredString(this.fontRenderer, "Add server", this.width / 2, this.height / 4 - 60 + 20, 16777215);
        ...
        this.drawString(this.fontRenderer, "Enter the IP of a server to add to the server list:", this.width / 2 - 140, this.height / 4 + 36, 10526880);
